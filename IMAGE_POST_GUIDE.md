...
2. **URL:** `https://api.yourdomain.com/api/v1/posts`
3. **Headers:**
...
const response = await fetch('https://api.yourdomain.com/api/v1/posts', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_JWT_TOKEN',
...
url = 'https://api.yourdomain.com/api/v1/posts'
headers = {
    'Authorization': 'Bearer YOUR_JWT_TOKEN'
}
...
Future<void> uploadImagePost() async {
  var uri = Uri.parse('https://api.yourdomain.com/api/v1/posts');
...
fetch('https://api.yourdomain.com/api/v1/posts', {
  method: 'POST',
  headers: {
...
1. Open Postman
2. POST → `https://api.yourdomain.com/api/v1/posts`
